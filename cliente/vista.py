...
from modelo.consultas_dao import crear_tabla, Peliculas, guardar_peli,listar_peli,listar_generos,editar_peli,borrar_peli, listar_director
...
class Frame(tk.Frame):  
    ...
    def label_form(self):    
        ...
        self.label_nombre.config(font=('Arial',12,'bold'))    
        self.label_nombre.grid(row= 0, column=2,padx=10,pady=10)
        
        self.label_nombre = tk.Label(self, text="Duración: ")    
        self.label_nombre.config(font=('Arial',12,'bold'))    
        self.label_nombre.grid(row= 1, column=0,padx=10,pady=10)    
        
        self.label_nombre = tk.Label(self, text="Generos: ")    
        self.label_nombre.config(font=('Arial',12,'bold'))    
    ...
    def input_form(self):
        ...
        self.entry_nombre.config(width=20,state='disabled',font=('Arial', 12))    
        self.entry_nombre.grid(row= 0, column=1,padx=10,pady=10,columnspan='2')  
          
        '''
        self.director = tk.StringVar()
        self.entry_director = tk.Entry(self, textvariable=self.director)    
        self.entry_director.config(width=20,state='disabled',font=('Arial', 12))      
        ...
        self.entry_duracion.config(width=20,state='disabled',font=('Arial', 12))      
    ...
    #
        ...
        self.director_peli1 = ['Selecione Uno'] + m
        self.director_peli = ttk.Combobox(self, state="readonly")
        self.director_peli['values'] = self.director_peli1
        self.director_peli.current(0)
        self.director_peli.config(width=25, state='disabled', font=('Arial',12))    
        self.director_peli.bind("<<ComboboxSelected>>")    
        self.director_peli.grid(row= 0, column=3,padx=10,pady=10,columnspan='2')
    ...
    def habilitar_campos(self):    
        ...
        self.director_peli.config(state='normal')   
    ...
    def bloquear_campos(self):    
        ...
        self.director_peli.config(state='disabled')  
    ...
    def mostrar_tabla(self):
        ...
        self.tabla = ttk.Treeview(self, columns=('Nombre','Duración','Genero','Director'))
    #
    ...
    def editar_registro(self):
        try:
            ...
            self.director_peli = self.tabla.item(self.tabla.selection())['values'][1]
            self.dura_peli = self.tabla.item(self.tabla.selection())['values'][2]
            self.gene_peli = self.tabla.item(self.tabla.selection())['values'][3]
         ...
         #   self.director.set(self.director_peli)
            ...
            self.director_peli.current(self.director_peli.index(self.director_peli))
        except:
            pass
    ...
    def eliminar_registro(self):
        try:
            ...
            self.id_director_peli= self.tabla.item(self.tabla.selection())['text']
            borrar_director_peli(int(self.id_director_peli))
            self.mostrar_tabla()
        except:
            pass
...
def barrita_menu(root):  
    ...
    #submenu ayuda
    menu_inicio2.add_command(label='@instagram')  
    menu_inicio2.add_command(label='What s app: xxxx')  
    menu_inicio2.add_command(label='Facebook: xxx')